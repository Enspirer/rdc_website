    ...
    <form action="{{route('admin.projects.updateimage')}}" method="post" enctype="multipart/form-data">
        ...
        <div class="row">
            ...
            <div class="card">
                                    ...
                                    <table class="table table-bordered table-striped" id="user_table">
                                        ...
                                        <tfoot>
                                            @foreach($multiple as $key => $single_image)
                                                <tr>
                                                    <td><div class="form-row"><img class="p-1" src="{{url('files/projects/',$single_image->image)}}" style="width: 60%;" alt="" ><input type="text" class="form-control col-sm-2 ml-3 mt-5" name="image_order[]" value="{{ $single_image->order }}"></div></td>
                ...
                <button type="submit" class="btn btn-success pull-right">Add Images</button>&nbsp;&nbsp;&nbsp;
